...
try {
   ...
   // await page.click('#main-wrapper > div > div.scrollable-panes-height-taker > div > div > div.bf-row.no-bottom-gutter.nested-scrollable-pane-parent.extra-links-space-3.hidden-when-left-side-collapsed.extra-links-space-2 > div > bf-navigation-lhm > div > div > ng-include > div > div > ul > li:nth-child(2) > tree-section > ul > li > tree-section > ul > li > tree-section > ul > li > tree-section > ul > li > tree-section > span > div > div > div > ul > li.node.node1217635170')
...
try{
      ...
      // BETCLIC
          ...
          var Todd1 = parseFloat(await page3.$eval('body > app-desktop > div.layout > div > bcdk-content-scroller > div > sports-match-page > div.marketBox_container.is-active > sports-match-markets > bcdk-vertical-scroller > div > div.verticalScroller_wrapper > div > div > sports-grouped-markets:nth-child(1) > div > div:nth-child(2) > div:nth-child('+(index+2)+') > div.marketBox_list > div:nth-child(1) > sports-selections-selection > div > span.oddValue', div => div.textContent.trim().replace(',', '.')));
          ...
          var Todd2 = parseFloat(await page3.$eval('body > app-desktop > div.layout > div > bcdk-content-scroller > div > sports-match-page > div.marketBox_container.is-active > sports-match-markets > bcdk-vertical-scroller > div > div.verticalScroller_wrapper > div > div > sports-grouped-markets:nth-child(1) > div > div:nth-child(4) > div:nth-child('+(index+2)+') > div.marketBox_list > div:nth-child(1) > sports-selections-selection > div > span.oddValue', div => div.textContent.trim().replace(',', '.')));
    ...
    console.log('betclic '+error.message) 
}    
...
//   }
  ...
  Todd1 = parseFloat(await page2.$eval('body > div.root-wrapper.match-odds-route-page > div > section.main-content-wrapper > div.grid__row.main-content-wrapper__content > div.grid__column.grid__column--fluid.grid__column__main-content > section > div > div.markets > div > div:nth-child(1) > div:nth-child(1) > div > div:nth-child(2) > div > div:nth-child(1) > div:nth-child('+(index+2)+') > div.columns-values > div > div:nth-child(1) > button', div => div.textContent.trim()));
  //console.log(TN1 + "-" + Todd1);
  ...
  Todd2 = parseFloat(await page2.$eval('body > div.root-wrapper.match-odds-route-page > div > section.main-content-wrapper > div.grid__row.main-content-wrapper__content > div.grid__column.grid__column--fluid.grid__column__main-content > section > div > div.markets > div > div:nth-child(1) > div:nth-child(1) > div > div:nth-child(2) > div > div:nth-child(2) > div:nth-child('+(index+2)+') > div.columns-values > div > div:nth-child(1) > button > span', div => div.textContent.trim()));
  //console.log(TN2 + "-" + Todd2);
