...
(async () => {
    let browser = await puppeteer.launch({
        executablePath: 'C:/Users/max_r/OneDrive/Ambiente de Trabalho/chrome-win/chrome.exe',
        headless: false,
    ...
    for (let index = 0; index < NumberOfPlayers; index++) {
      ...
      if( isNaN(LayOdd) || isNaN(BackOdd)){
        ...
        if(Names.includes(Name)){
            Backs[Names.indexOf(Name)] = BackOdd;
            Lays[Names.indexOf(Name)] = LayOdd;
            Avgs[Names.indexOf(Name)] = Average;
        }else{
            Names.push(Name);
            Backs.push(BackOdd);
            Lays.push(LayOdd);
...
//         findBetclic(TN1, Names, 0.5, Todd1);
//         findBetclic(TN2, Names, 0.5, Todd2);
//         }
...
for (let i = 0; i < urls2.length; i++) {
  ...
  await page2.click('#app > div > div:nth-child(2) > section.main-content-wrapper > div.grid__row.main-content-wrapper__content > div.grid__column.grid__column--fluid.grid__column__main-content > section > div > div.markets.tw-mx-n.tw-mt-n > div:nth-child(1) > div > div > div.tw-mt-nm.tw-px-s > div > button');

  await page2.waitForTimeout(1500);
    
  var game = await page2.$eval('#app > div > div > section.main-content-wrapper > div.grid__row.main-content-wrapper__content > div.grid__column.grid__column--fluid.grid__column__main-content > section > nav > ul > li:nth-child(5) > span', div => div.textContent.trim());
  var hour = await page2.$eval('#app > div > div > section.main-content-wrapper > div.grid__row.main-content-wrapper__content > div.grid__column.grid__column--fluid.grid__column__main-content > section > div > div.event-details__container > div > div.event-details__info > div > div', div => div.textContent.trim());
...
var count = 0;
  ...
  for (let index = 0; index < NumberOfPlayersBetano; index++) {
    ...
    TN1 = await page2.$eval('#app > div > div:nth-child(2) > section.main-content-wrapper > div.grid__row.main-content-wrapper__content > div.grid__column.grid__column--fluid.grid__column__main-content > section > div > div.markets.tw-mx-n.tw-mt-n > div:nth-child(1) > div > div > div.tw-mt-nm.tw-px-s > div > div:nth-child(1) > div:nth-child('+(index+2)+') > div.row-info > div > div', div => div.textContent.trim());
    TN2 = await page2.$eval('#app > div > div:nth-child(2) > section.main-content-wrapper > div.grid__row.main-content-wrapper__content > div.grid__column.grid__column--fluid.grid__column__main-content > section > div > div.markets.tw-mx-n.tw-mt-n > div:nth-child(1) > div > div > div.tw-mt-nm.tw-px-s > div > div:nth-child(2) > div:nth-child('+(index+2)+') > div.row-info > div > div', div => div.textContent.trim());
  ...
  // var asd = await page2.$eval('#app > div > div:nth-child(2) > section.main-content-wrapper > div.grid__row.main-content-wrapper__content > div.grid__column.grid__column--fluid.grid__column__main-content > section > div > div.markets.tw-mx-n.tw-mt-n > div:nth-child(1) > div > div > div.tw-mt-nm.tw-px-s > div > div:nth-child(1) > div:nth-child(2) > div.columns-values > div > div:nth-child(2) > div', div => div.textContent.trim());
  // console.log(asd)
    //TEAM 1
    Todd1 = parseFloat(await page2.$eval('#app > div > div:nth-child(2) > section.main-content-wrapper > div.grid__row.main-content-wrapper__content > div.grid__column.grid__column--fluid.grid__column__main-content > section > div > div.markets.tw-mx-n.tw-mt-n > div:nth-child(1) > div > div > div.tw-mt-nm.tw-px-s > div > div:nth-child(1) > div:nth-child('+(index+2)+') > div.columns-values > div > div:nth-child(2) > div', div => div.textContent.trim()));
    console.log(TN1 + " - " + Todd1);

    //TEAM 2
    Todd2 = parseFloat(await page2.$eval('#app > div > div:nth-child(2) > section.main-content-wrapper > div.grid__row.main-content-wrapper__content > div.grid__column.grid__column--fluid.grid__column__main-content > section > div > div.markets.tw-mx-n.tw-mt-n > div:nth-child(1) > div > div > div.tw-mt-nm.tw-px-s > div > div:nth-child(2) > div:nth-child('+(index+2)+') > div.columns-values > div > div:nth-child(2) > div', div => div.textContent.trim()));
    console.log(TN2 + " - " + Todd2);

    // Create a string with the combined data
    let textData = '';
    for (let i = 0; i < Names.length; i++) {
      textData += `${Names[i]},${Lays[i]}\n`;
    }
    ...
    for (const name of namesArray) {
      ...
      if (similarity >= threshold) {
        ...
        if(Lays[indexi]==0){
          ...
          if( isNaN(edges[indexi]) || isNaN(edges[indexi])){
            edges[indexi] = 0;
          }else{
            console.log('----- ' + edges[indexi] + name)
          if(currentOdds[indexi] > odds){
            ...
            if(currentOdds[indexi] >= Lays[indexi]){
                ...
                if((edge*100) > edges[indexi]){
                  edges[indexi] = edge*100;
                  sendMessageToGroup(
                    "Game- " + betURL + "\n\n" + 
                    "Start- " + hours + "\n\n" + 
                    name + " -----> Betano @" + currentOdds[indexi] + "\n\n" + "True Odd @" + Lays[indexi] + " Edge -> " + edge*100+"%" + "\n");
                  }else{
                    }
                }
